                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $travel['first_name'] . ' ' . $travel['last_name'] ?></td>
                            <td class="text-center"><?php echo $travel['email'] ?></td>
